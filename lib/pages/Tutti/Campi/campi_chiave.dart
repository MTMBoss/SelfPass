...
class PasswordCampo extends StatelessWidget {
...
class PasswordAdminCampo extends StatelessWidget {
  final TextEditingController controller;
  final VoidCallback? onRemove;

  const PasswordAdminCampo({
    super.key,
    required this.controller,
    this.onRemove,
  });
...
class PasswordWiFiCampo extends StatelessWidget {
  final TextEditingController controller;
  final VoidCallback? onRemove;

  const PasswordWiFiCampo({super.key, required this.controller, this.onRemove});
...
class ChiaveAttivazioneCampo extends StatelessWidget {
  final TextEditingController controller;
  final VoidCallback? onRemove;

  const ChiaveAttivazioneCampo({
    super.key,
    required this.controller,
    this.onRemove,
  });
